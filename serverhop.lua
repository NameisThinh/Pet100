...
local function getServer()
        ...
        local success, _ = pcall(function()
            servers = game.HttpService:JSONDecode(game:HttpGet('https://games.roblox.com/v1/games/' .. tostring(game.PlaceId) .. '/servers/Public?sortOrder=Asc&limit=30')).data
        end)
    ...
    --     return getServer()
    -- end
        local server = servers[Random.new():NextInteger(2, 30)]
